...
class marker_detection:
	...
	def __init__(self):
		...
		self.mission_sub = rospy.Subscriber("/startDetection",String,self.getMissionCallBack,  queue_size = 1)
		self.mission_pub = rospy.Publisher("/endDetection", String, queue_size = 1)
	...
	def getMissionCallBack(self, msg):
		if msg.data == 'startDetection' :
		   self.startFlag = True ; 
